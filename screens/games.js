    ...
    return (
      <View style={{height: '100%'}}>
        ...
        /> */}
          ...
          <Text style={{fontSize: 24, fontWeight: 'bold'}}>Business Insights</Text>
          </View>
      ...
      >
        ...
        <View style={[styles.box, { elevation: 2 }]} >
          <Text style={styles.discount}>₹{totalBill}</Text>
          <Text>For today</Text>
